                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                  ...
                                                  <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                                      ...
                                                      <a class="dropdown-item"  onclick="return confirm('Etes vous sur de  vouloir retirer les droits a cet utlisateur.?'); " href="partials/supprimer_droit.php?ID_PERSONNEL=<?= $personnel['ID_PERSONNEL'] ?>">
